...
#'   \item{\code{genoMap} (\code{data.frame}): }{ Coordinates of the 3333
#'   individuals' markers. This data.frame contains 3 columns: \code{chr},
#'   \code{pos} and \code{lociNames}.} \item{\code{lociEffects} (\code{numeric}): }{
...
#'
#' @aliases genotypes genoMap lociEffects
#'
#' @examples
